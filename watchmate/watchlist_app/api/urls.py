...
from watchlist_app.api.views import WatchListAV, MovieDetailsAV, StreamPlatformAV, ReviewAV, ReviewDetailsAV, ReviewCreateAV, WatchListSearch
...
urlpatterns = [
    ...
    path('movies/list2/', WatchListSearch.as_view(), name='watchlist-search')
]
